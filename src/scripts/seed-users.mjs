...
const demoUsers = [
	{
		name: "Admin",
		fullName: "Administrador Empresa Plana",
		phone: "+34 977 553 680",
		email: "admin@empresaplana.cat",
		passkey: "ADMIN1234",
		username: "admin",
		role: "admin",
	},
	{
		name: "Worker",
		fullName: "Personal de Conducción",
		phone: "+34 600 000 001",
		email: "worker@empresaplana.cat",
		passkey: "WORKER12",
		username: "worker",
		role: "worker",
	},
...
const rows = await db.execute(
	"SELECT id, username, role, email, substr(passkey_hash, 1, 12) AS hash_prefix FROM usuarios ORDER BY id",
);
